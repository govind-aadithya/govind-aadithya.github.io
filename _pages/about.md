...
redirect_from: 
  ...
  - /about.html
---
I'm a PhD Candidate at the [Robot Motor Intelligence (ROMI) Lab](https://www.romilab.org/) in National Robotarium, Heriot-Watt University. Working with [Dr. Carlos Mastalli](https://www.romilab.org/team/carlos-mastalli), I'll be focusing on learning a unified behavioural space for different skills in robotics to enable cross-platform skill transfer.
<!--I'll be focusing my research on unifying model-based control and deep learning to enable learning behavioural signatures for dynamically balanced loco-manipulation in legged robots.-->  
I recieved my Master of Science degree in Mechatronics and Robotics at the New York University and worked as a Research Affiliate at the [Applied Dynamics and Optimization Lab](https://wp.nyu.edu/adol/) (ADOL) collaborating with [Dr. Joo H. Kim](https://engineering.nyu.edu/faculty/joo-h-kim). During this time I worked on developing a data capture and state estimation pipeline using VICON for our Robotis OP3 humanoid robot amd worked on my [Master's thesis]() focusing on building a simulation platform with MuJoCo for Robotis OP3 robot that can be integrated with the Robotis' ROS framework and sparse trajectory generation frameworks and control cycle syncing for better sim2real transfer.  
I recieved my Bachelor of Technology in Mechatronics Engineering at SRM Institute of Science and Technology (SRM University), India. During this period, I was part of a student research group SRM Team Humanoid where we worked on many projects intending to participate in the Robogames competition representing India on an international scale. We participated thrice when I was a core team member and won several medals.  
